...
DefaultPalette = Palette(
    id="0",
    bases={
        # --- a harness topology, which is drawn by the same renderer -------
        "Topology": "topology",
    ...
    colors={
        "topology": "#6db2ff",
        "topology.input": "#6db2ff",
        "topology.worker": "#8ab4f8",
        "topology.gate": "#e0c069",
        "topology.store": "#5ac8b0",
        "topology.output": "#b39ddb",
        "unknown": "gray",
        "async": "pink",
        "async.for": "pink",
        "async.with": "pink",
