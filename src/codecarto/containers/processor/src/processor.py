            ...
            if plot:
                ...
                if json:  # this is asking if we should convert back from json to graph
                    ...
                    if grid:
                        ...
                        print_status(
                            "Plotting all layouts in separate files...", from_api
                        )
...
def save_json(json_data: dict, json_file_path: str):
    import os
    ...
    try:
        ...
        print(f"Failed to save data to {json_file_path}.")
        raise e
    ...
    if os.path.exists(json_file_path):
        ...
        print(f"File {json_file_path} was not created.")
        return False
