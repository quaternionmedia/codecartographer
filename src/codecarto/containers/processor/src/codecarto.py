###################################################################
# THIS IS A COPY OF 'LOCAL' PROCESSOR.PY
# THIS IS JUST USED TO TEST PLOTTING AND JSON CONVERSION IN THE API
###################################################################
# EVERYTHING COMMENTED OUT FOR NOW BECAUSE THERE ARE A BUNCH OF
# REQUIRED REWORKS NEEDED FOR USING DATABASE INSTEAD OF LOCAL FILES
###################################################################
...
# # CW: I talk myself back and forth for the need of this module.
...
#         # CW: Move this to a Logging sub module
