...
export const Parser = ({ state, update }) => [
  ...
  m("section#github_url", [
    m("form#githubForm", [
      ...
      m("button", { id: "githubUrl_btn", type: "button", onclick: handleGithubURL }, "Submit"),
      m("div#github_loader", { class: "loader", style: "display: none" }, "Loading ..."),
    ]),
    m("div#url_content")
  ]),
  m("section#parser_display", [
      m("div#graph_desc")
  ])
];
